...
public class EditMovie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MoviesRef = FirebaseDatabase.getInstance().getReference().child("users").child(userId).child("DatabaseExample2");
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(com.example.practicafirebasev2.EditMovie.this, com.example.practicafirebasev2.MainActivity.class);
    ...
    private void myNewMovie(String idmovies, String movieName, String moviePoster, float rating) {
        ...
        mDatabaseReference.child("users").child(userId).child("DatabaseExample2").child(movie.getId()).setValue(movie);
    }
